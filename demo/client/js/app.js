 ...
 */
var myApp = angular.module('acDemo', ['lbServices', 'material.autocomplete']);

var myController = function ($scope, Product) {
...
myApp.controller('acController', ['$scope', 'Product', myController]);
