/* materializecss-autocomplete - v1.0.13 - 2017-09-06 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d) {
        function e() {
            f(), g(), x.parentForm && null !== x.parentForm && x.parentForm.$setDirty();
        }
        function f() {
            x.searchText = "";
        }
        ...
        function m(a, b) {
            a ? (x.displayProperty1 && (x.searchText = a[x.displayProperty1]), x.parentForm && null !== x.parentForm && x.parentForm.$setDirty()) : b && x.searchText && b[x.displayProperty1] === x.searchText && (x.searchText = ""), 
            a !== b && n();
        }
        function n() {
        ...
        var x = this;
        d(function() {
            x.parentForm = a.parentForm, x.immediateParentForm = a.immediateParentForm;
        }, 20);
        var y = {
            COMMA: 188,
            SEMICOLON: 186,
        ...
        x.hidden = !0, x.searchText || (x.searchText = ""), x.init = function() {
            ...
            x.removePlaceHolder(), A = !1, z || (x.hidden = i()), x.checkError() ? (x.parentForm && null !== x.parentForm && x.parentForm.$setValidity("selection", !1), 
            x.immediateParentForm && (x.immediateParentForm.$setValidity("selection", !1), x.immediateParentForm[x.inputFieldName].$setValidity("selection", !1))) : (x.parentForm && null !== x.parentForm && x.parentForm.$setValidity("selection", !0), 
            x.immediateParentForm && (x.immediateParentForm.$setValidity("selection", !0), x.immediateParentForm[x.inputFieldName].$setValidity("selection", !0)));
            ...
            var a = !1;
            return x.parentForm && null !== x.parentForm && (a = x.parentForm.$submitted), x.required && !x.disableInput && !x.selectedItem && (x.isInputBlur || a);
        };
    };
