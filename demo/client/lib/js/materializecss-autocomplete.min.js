/* materializecss-autocomplete - v1.0.13 - 2017-08-19 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d) {
        ...
        x.hidden = !0, x.searchText || (x.searchText = ""), x.init = function() {
            ...
            x.removePlaceHolder(), A = !1, z || (x.hidden = i()), x.checkError() ? (x.parentForm.$setValidity("selection", !1),
            x.immediateParentForm && (x.immediateParentForm.$setValidity("selection", !1), x.immediateParentForm[x.inputFieldName].$setValidity("selection", !1))) : (x.parentForm.$setValidity("selection", !0),
