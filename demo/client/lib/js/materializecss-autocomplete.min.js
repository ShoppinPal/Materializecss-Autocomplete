/* materializecss-autocomplete - v1.0.12 - 2017-08-18 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c, d) {
        ...
        x.hidden = !0, x.searchText || (x.searchText = ""), x.init = function() {
            ...
            x.immediateParentForm.$setValidity("selection", !1), x.immediateParentForm[x.inputFieldName].$setValidity("selection", !1)) : (x.parentForm.$setValidity("selection", !0),
            x.immediateParentForm.$setValidity("selection", !0), x.immediateParentForm[x.inputFieldName].$setValidity("selection", !0));
