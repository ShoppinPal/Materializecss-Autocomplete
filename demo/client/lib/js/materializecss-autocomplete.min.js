/* materializecss-autocomplete - v1.0.3 - 2017-05-25 */
!function() {
    "use strict";
    ...
    var a = function(a, b, c) {
        ...
        function u(a) {
            w.uniquedisplayProperty1 && (a = t(a)), w.itemList = a, w.hidden = h(), w.loading && q(!1);
        }
        function v(a) {
            var b = [];
        ...
        w.hasNotFound = !1, w.hidden = !0, w.searchText || (w.searchText = ""), w.init = function() {
            ...
            angular.isFunction(w.onFocusCb) && w.onFocusCb(), w.setPlaceHolder(), z = !0, i() && w.remoteMethod && s(), 
            w.hidden = h();
        }, w.blur = function(a) {
            angular.isFunction(w.onBlurCb) && w.onBlurCb(), w.removePlaceHolder(), z = !1, y || (w.hidden = h());
