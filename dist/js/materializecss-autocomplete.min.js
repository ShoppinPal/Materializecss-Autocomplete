/* materializecss-autocomplete - v1.0.11 - 2017-08-17 */
!function() {
    "use strict";
    ...
    var a = function(a) {
        return {
            ...
            link: function(b, c, d, e) {
                a(function() {
                    b.parentForm = e[0], e[0] && e[0].$$parentForm.$name && (b.parentForm = e[0].$$parentForm), 
                    b.$apply();
                }, 10);
            }
        };
    ...
    var a = function(a, b, c, d) {
        ...
        x.hidden = !0, x.searchText || (x.searchText = ""), x.init = function() {
            ...
            x.parentForm[x.inputFieldName].$setValidity("selection", !1)) : (x.parentForm[x.inputFieldName].$setValidity("selection", !0), 
            x.parentForm.$setValidity("selection", !0));
