/* materializecss-autocomplete - v1.0.0 - 2017-05-10 */
!function() {
    "use strict";
    ...
    "use strict";
    var a = function() {
        var a = document.querySelector("script[src$='materializecss-autocomplete.js']"), b = a.src;
        return {
            restrict: "E",
            scope: {},
            bindToController: {
    ...
    var a = function(a, b, c) {
        ...
        function h(a, b) {
            t.index = -1, a !== b && (t.selectedItem && t.displayProperty1 ? (n(!1), t.selectedItem[t.displayProperty1] !== a && (t.selectedItem = null, 
            t.hidden = e())) : t.remoteMethod && o(a));
        }
        function i(a, b) {
            a ? t.displayProperty1 && (t.searchText = a[t.displayProperty1]) : b && t.searchText && b[t.displayProperty1] === t.searchText && (t.searchText = ""), 
            a !== b && j();
        }
        function j() {
        ...
        function q(a) {
            for (var b = [], c = {}, d = 0; d < a.length; d++) c[a[d][t.displayProperty1]] || (c[a[d][t.displayProperty1]] = !0, 
            b.push(a[d]));
            return b;
        }
        function r(a) {
            t.uniquedisplayProperty1 && (a = q(a)), t.itemList = a, t.hidden = e(), t.loading && n(!1);
        }
        function s(a) {
            var b = [];
        ...
        t.hasNotFound = !1, t.hidden = !0, t.searchText || (t.searchText = ""), t.init = function() {
            ...
            t.searchText = a[t.displayProperty1], t.selectedItem = a, t.hidden = e();
